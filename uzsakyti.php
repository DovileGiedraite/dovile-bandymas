...
<h1 class="antraste">Užsakytų FILMŲ SĄRAŠAS</h1>
<div class="remai">
<!-- <h2>Antraštė</h2> -->
<div class="lentele">
...
try {
    ...
    JOIN uzsakyma ON filmai.ID=uzsakyma.uzsakFilmID
    JOIN kurejai ON filmai.kurejoID=kurejai.ID 
    WHERE uzsakyma.uzsakVartID=$VartorojoID;";
