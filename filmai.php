...
<h1 class="antraste">Naujų filmų įkėlimas</h1>
<div class="remai">
<div class="lentele">
...
<label for="autorius"><b>Filmo autorius:</b></label><br><br>
...
try {
    $db=new PDO("mysql:host=$serveris;dbname=filmai", $vardas, $slaptazodis);
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $sql="INSERT INTO filmai( pavadinimas, isleidMetai, kurejoID) 
    VALUES ('$pavadinimas','$data','$autorius');";
    $db->exec($sql);
